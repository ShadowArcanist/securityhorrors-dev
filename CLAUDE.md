...
## Adding a New Security Horror Story

### 1. Create the post file

Create `src/content/blog/{vendor}-{summary}.md` (e.g. `cloudflare-token-leak.md`).
...
tags:
  - cloudflare                # Vendor/product + relevant tags (breach, vuln, outage, etc.)
  - breach
author: Andras Bacsai
authorTwitter: heyandras
date: "2026-02-10T12:34:56.789Z"  # ISO date string
image: /assets/{vendor}-{summary}.{ext}  # Local image in public/assets/
category: security
...
Save the screenshot/image to `public/assets/{vendor}-{summary}.{ext}` (png/jpg/webp).
